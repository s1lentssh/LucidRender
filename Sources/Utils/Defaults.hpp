...
struct Defaults
{
    inline static const std::uint32_t Width = 1920;
    inline static const std::uint32_t Height = 1080;
    ...
    inline static const std::array<float, 4> BackgroundColor = { 0.03f, 0.03f, 0.03f, 1.0f };
