...
VulkanDescriptorPool::VulkanDescriptorPool(VulkanDevice& device) : mDevice(device)
{
	...
	auto sampledImagePoolSize = vk::DescriptorPoolSize()
		.setDescriptorCount(kMaxDescriptorCount)
	...
	vk::DescriptorPoolSize poolSizes[] = 
	{
		...
		uniformTexelPoolSize,
		uniformStoragePoolSize,
		uniformPoolSize,
		storagePoolSize,
		uniformDynamicPoolSize,
		storageDynamicPoolSize,
		inputAttachmentPoolSize
	};
